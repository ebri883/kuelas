...
<link rel="stylesheet" href="{{asset('assets/css/responsive.css')}}" >
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="p">
            <a class=" nav-link" href="/anggota"> <i class="ni ni-tv-2 text-blue"></i> Dashboard
            </a>
          </li>
          <li class="p">
          ...
          <li class="p" style="background-color: #5e72e4; color: white !important;">
            <a class="nav-link" style="color: white !important; font-weight:" href="/anggota/profile">
...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-uppercase d-none text-white d-lg-inline-block" href="/anggota/profile">User Profil</a>
      </div>
    </nav>
    <!-- End Navbar -->
