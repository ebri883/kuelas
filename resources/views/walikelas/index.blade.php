    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <a class=" nav-link" style="color: white !important; font-weight: bold;" href="/dashboard"> <i class="ni ni-tv-2 text-white"></i>Dashboard
            </a>
          </li>
          <li class="p">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="/walikelas/user/tambah" class="btn btn-sm btn-primary">Tambah</a>
                </div>
              </div>
            </div>
