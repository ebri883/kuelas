...
<link rel="stylesheet" href="{{asset('assets/css/responsive.css')}}" >
    ...
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-2" href="/walikelas">
      ...
      <ul class="nav align-items-center d-md-none">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            ...
            <a href="/walikelas/profile" class="dropdown-item">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="p" style="background-color: #5e72e4; color: white !important;">
            <a class="nav-link" style="color: white !important; font-weight:" href="/walikelas/profile">
...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-uppercase d-none text-white d-lg-inline-block" href="/walikelas/profile">User Profil</a>
      </div>
    </nav>
    <!-- End Navbar -->
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                ...
                <div class="h4 mt-3 text-uppercase ">
                  <i class="ni business_briefcase-24 mr-2">{{Auth::user()->role}} - {{ $user->kelas->nama_kelas }}</i>
                </div>
              </div>
            </div>
          </div>
              ...
              <form>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-regular" disabled value="{{Auth::user()->nama}}" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-regular" disabled value="{{Auth::user()->absen}}" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-regular" disabled value="{{Auth::user()->email}}" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <input id="input-address" class="form-control form-control-regular" disabled value="{{ $user->kelas->nama_kelas }}" type="text">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-address">Kode Kelas</label>
                        <input id="input-address" class="form-control form-control-regular" disabled value="{{ $user->kode_kelas }}" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
